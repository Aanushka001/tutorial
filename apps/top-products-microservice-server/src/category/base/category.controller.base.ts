...
export class CategoryControllerBase {
  ...
  @common.Get("/:id/get-product-details")
  ...
  async GetProductDetails(
    ...
    return this.service.GetProductDetails(body);
  }

  @common.Get("/categories/:categoryname/products/:productid")
  @swagger.ApiOkResponse({
  ...
  async GetProductDetailsInCategory(
    ...
    return this.service.GetProductDetailsInCategory(body);
  }

  @common.Get("/categories/:categoryname/products")
  @swagger.ApiOkResponse({
  ...
  async GetTopProductsInCategory(
    ...
    return this.service.GetTopProductsInCategory(body);
  }

  @common.Get("/:id/get-top-products-within-category")
  @swagger.ApiOkResponse({
    type: String,
  })
  @swagger.ApiNotFoundResponse({
  ...
  async GetTopProductsWithinCategory(
    ...
    return this.service.GetTopProductsWithinCategory(body);
  }
}
