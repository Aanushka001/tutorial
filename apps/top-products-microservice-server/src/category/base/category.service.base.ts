...
export class CategoryServiceBase {
  ...
  async GetProductDetails(args: string): Promise<string> {
    throw new Error("Not implemented");
  }
  async GetProductDetailsInCategory(args: string): Promise<ProductDetailDto> {
    throw new Error("Not implemented");
  }
  async GetTopProductsInCategory(args: string): Promise<ProductListItemDto[]> {
    throw new Error("Not implemented");
  }
  async GetTopProductsWithinCategory(args: string): Promise<string> {
    throw new Error("Not implemented");
  }
}
